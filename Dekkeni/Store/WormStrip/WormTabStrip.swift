...
public struct WormTabStripStylePropertyies {
    ...
    var tabItemDefaultFont:UIFont = UIFont(name: "DIN Alternate", size: 14)!
    var tabItemSelectedFont:UIFont = UIFont(name: "DIN Alternate", size: 18)!
    ...
    //UIColor(displayP3Red: 61/255, green: 103/255, blue: 40/255, alpha: 0.7)
    
    var tabItemSelectedColor:UIColor = .white
    
    //color for worm
    var WormColor:UIColor = UIColor.white
    
    var topScrollViewBackgroundColor:UIColor = .red
    
    var contentScrollViewBackgroundColor:UIColor = .white
